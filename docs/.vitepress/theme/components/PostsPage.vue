 ...
 * PostsPage — 文章列表页完整组件
 * 包含：两栏布局、标签过滤、归档统计
 * 在 posts/index.md 中直接使用 <PostsPage />
 */
    ...
    <aside class="posts-aside">
      ...
      <div class="aside-block">
        ...
        <div class="tag-cloud">
          ...
          >
            {{ tag }}
            <span class="tag-count">{{ tagPosts?.length ?? 0 }}</span>
          </button>
          <p v-if="sortedTags.length === 0" class="aside-empty">暂无标签</p>
        </div>
      </div>
      ...
      <div class="aside-block">
        ...
        <div class="archive-list">
          ...
          <p v-if="archiveByYear.length === 0" class="aside-empty">暂无文章</p>
        </div>
      </div>
